 ...
 * Constructor
 */
MemberListEntry::MemberListEntry(int id, short port, long heartbeat, long timestamp, bool failed): id(id), port(port), heartbeat(heartbeat), timestamp(timestamp), failed(failed) {}
 ...
 * DESCRIPTION: getter
 */
bool MemberListEntry::getfailed() {
	return failed;
}
 ...
 * DESCRIPTION: setter
 */
void MemberListEntry::setfailed(bool failed) {
	this->failed = failed;
}
